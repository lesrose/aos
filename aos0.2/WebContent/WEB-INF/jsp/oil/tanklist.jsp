...
<body>
	...
	<div class="publicHeaderR">
		<p>
			<span>下午好！</span><span style="color: #fff21b"> </span> 欢迎你！
		</p>
	...
	<div class="left">
		...
		<ul class="list">
			...
			<li><a href="${pageContext.request.contextPath }/stlist.action">加油站查看</a></li>
	...
	<div class="right">
		...
		<table class="providerTable" cellpadding="0" cellspacing="0">
			...
			<c:forEach items="${autho }" var="item">
				<tr>
					...
					<td><a
						href="${pageContext.request.contextPath }/updatetank.action?id=${item.id} "><img
							src="img/xiugai.png" alt="修改" title="修改" /></a> <a
						href="${pageContext.request.contextPath }/showdata.action?id=${item.id} "><img
