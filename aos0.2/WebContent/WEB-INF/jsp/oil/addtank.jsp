...
<!--主体内容-->
    ...
    <div class="right">
        <div class="location">
            ...
            <span>油罐计量>>油罐查看>>油罐数据添加页面</span>
        </div>
        <div class="providerAdd">
            <form action="${pageContext.request.contextPath }/addTankdataSubmit.action" method="post">
                <!--div的class 为error是验证错误，ok是验证成功-->
                <div>
                    <label for="oilName">油量高度：</label>
                    <input type="text" name="height" id="oilName" required/>
                    <span >*油量高度：</span>
                </div>
                <div>
                    <label for="oilCom">油量体积：</label>
                    <input type="text" name="volume" id="oilCom" required/>
                    <span>*油量体积：</span>
                </div>
                <!--<div>
                    <label >是否付款：</label>
